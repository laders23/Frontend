...
function RegisterDetail() {
	useEffect(() => {
		...
		const warningSpaceMessages = {
			// input창 빈값일 경우, 표시되는 warning 모음집
			id: "아이디를 입력해주세요",
			...
			<form className="register__detail__form">
				<div className="reg__detail__box">
					...
					<label className="reg__input__label">
						...
						<input
							className="reg__detail__input"
							type="text"
							name="id"
							placeholder="4~20자리 / 영문, 숫자 가능, 특수문자 불가능"
						/>
					...
					<label className="reg__input__label">
						...
						<input
							className="reg__detail__input reg__email__input"
							type="text"
							name="email"
							placeholder="email@meetpro.co.kr"
						/>
						<div className="warning-alert" rel="warning__email"></div>
					</label>
					<div className="cert__reg__btn disabled" rel="cert__btn">
						인증요청
					</div>
					<div className="comp__reg__btn" rel="comp__btn">
						회원가입 완료
					</div>
				</div>
			</form>
