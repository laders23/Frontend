            ...
            <footer className='footerContainer'>
                <div className='footCategory'>
                    <div className='categoryBox'>
                        <div className='titleBox'><a className='cateTitle'>MeetPro</a></div>
                        <div><a href='#'>MeetPro 소개</a></div>
                        <div><a href='#'>MeetPro 비지니스</a></div>
                    </div>
                    <div className='categoryBox'>
                        <div className='titleBox'><a className='cateTitle'>개인정보처리방침</a></div>
                    </div>
                    <div className='categoryBox'>
                        <div className='titleBox'><a className='cateTitle'>이용약관</a></div>
                    </div>
                    <div className='categoryBox'>
                        <div className='titleBox'><a className='cateTitle'>고객센터</a></div>
